...
} from "store/report-device-siguelo/actions"
import TableIndex from "./table/tableIndex"
import ModalIndex from "./Modal/modalIndex"
import { ErrorTable } from "components/tableElements"
import { SpinnerL } from "components/components"

const _crudName = {single: "reportDeviceSiguelo", multiple: "reportDevices", cod: "reportDeviceSiguelo"}

const ReportDeviceSigueloPage = ({
    localStore,
    onGet,
    onPost,
    onPut,
        ...
        <React.Fragment>
            <div className="page-content mb-0 pb-0">
                <div className="container">
                    <Breadcrumbs title="Cuadros de mando" breadcrumbItem={"Buscar por Imei en plataformas"} />
...
ReportDeviceSigueloPage.propTypes = {
...
const mapStateToProps = state => ({
    localStore: state.ReportDeviceSiguelo
})
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslation()(ReportDeviceSigueloPage))